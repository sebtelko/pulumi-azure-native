...
export function getAlertRule(args: GetAlertRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetAlertRuleResult> {
    pulumi.log.warn("getAlertRule is deprecated: AlertRule is deprecated. Please use one of the variants: FusionAlertRule, MicrosoftSecurityIncidentCreationAlertRule, ScheduledAlertRule.")
    if (!opts) {
        opts = {}
    }
