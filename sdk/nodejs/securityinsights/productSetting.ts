 ...
 *
 * @deprecated ProductSetting is deprecated. Please use one of the variants: EntityAnalytics, EyesOn, Ueba.
 */
export class ProductSetting extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProductSetting {
        pulumi.log.warn("ProductSetting is deprecated: ProductSetting is deprecated. Please use one of the variants: EntityAnalytics, EyesOn, Ueba.")
...
export interface ProductSettingArgs {
     ...
     * The kind of the setting
     */
    readonly kind: pulumi.Input<string | enums.securityinsights.SettingKind>;
    /**
