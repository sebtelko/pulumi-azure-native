 ...
 */
/** @deprecated Environment is deprecated. Please use one of the variants: LongTermEnvironment, StandardEnvironment. */
export function getEnvironment(args: GetEnvironmentArgs, opts?: pulumi.InvokeOptions): Promise<GetEnvironmentResult> {
    pulumi.log.warn("getEnvironment is deprecated: Environment is deprecated. Please use one of the variants: LongTermEnvironment, StandardEnvironment.")
    if (!opts) {
        opts = {}
    }
