...
export function getMachineLearningService(args: GetMachineLearningServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetMachineLearningServiceResult> {
    pulumi.log.warn("getMachineLearningService is deprecated: MachineLearningService is deprecated. Please use one of the variants: ACIService, AKSService, EndpointVariant.")
    if (!opts) {
        opts = {}
    }
