 ...
 */
/** @deprecated DataConnection is deprecated. Please use one of the variants: EventGridDataConnection, EventHubDataConnection. */
export function getDataConnection(args: GetDataConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetDataConnectionResult> {
    pulumi.log.warn("getDataConnection is deprecated: DataConnection is deprecated. Please use one of the variants: EventGridDataConnection, EventHubDataConnection.")
    if (!opts) {
        opts = {}
    }
