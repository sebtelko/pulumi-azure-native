...
warnings.warn("""Addon is deprecated. Please use one of the variants: ArcAddon, IoTAddon.""", DeprecationWarning)
...
def get_addon(addon_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_addon is deprecated: Addon is deprecated. Please use one of the variants: ArcAddon, IoTAddon.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/v20200901preview:getAddon', __args__, opts=opts, typ=GetAddonResult).value
