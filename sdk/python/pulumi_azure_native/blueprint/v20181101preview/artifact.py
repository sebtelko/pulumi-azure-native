...
class Artifact(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_scope: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""Artifact is deprecated: Artifact is deprecated. Please use one of the variants: PolicyAssignmentArtifact, RoleAssignmentArtifact, TemplateArtifact.""")
        if opts is None:
