...
warnings.warn("""Artifact is deprecated. Please use one of the variants: PolicyAssignmentArtifact, RoleAssignmentArtifact, TemplateArtifact.""", DeprecationWarning)
...
def get_artifact(artifact_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_artifact is deprecated: Artifact is deprecated. Please use one of the variants: PolicyAssignmentArtifact, RoleAssignmentArtifact, TemplateArtifact.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:blueprint/v20181101preview:getArtifact', __args__, opts=opts, typ=GetArtifactResult).value
