...
warnings.warn("""SynchronizationSetting is deprecated. Please use one of the variants: ScheduledSynchronizationSetting.""", DeprecationWarning)
...
def get_synchronization_setting(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_synchronization_setting is deprecated: SynchronizationSetting is deprecated. Please use one of the variants: ScheduledSynchronizationSetting.""")
    __args__ = dict()
