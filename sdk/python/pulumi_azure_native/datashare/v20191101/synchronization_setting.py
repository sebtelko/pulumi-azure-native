...
class SynchronizationSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 synchronization_setting_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""SynchronizationSetting is deprecated: SynchronizationSetting is deprecated. Please use one of the variants: ScheduledSynchronizationSetting.""")
        if opts is None:
