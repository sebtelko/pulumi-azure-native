...
warnings.warn("""Trigger is deprecated. Please use one of the variants: ScheduledTrigger.""", DeprecationWarning)
...
def get_trigger(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_trigger is deprecated: Trigger is deprecated. Please use one of the variants: ScheduledTrigger.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20191101:getTrigger', __args__, opts=opts, typ=GetTriggerResult).value
