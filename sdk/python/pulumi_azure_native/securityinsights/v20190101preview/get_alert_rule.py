...
warnings.warn("""AlertRule is deprecated. Please use one of the variants: FusionAlertRule, MLBehaviorAnalyticsAlertRule, MicrosoftSecurityIncidentCreationAlertRule, ScheduledAlertRule, ThreatIntelligenceAlertRule.""", DeprecationWarning)
...
def get_alert_rule(operational_insights_resource_provider: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_alert_rule is deprecated: AlertRule is deprecated. Please use one of the variants: FusionAlertRule, MLBehaviorAnalyticsAlertRule, MicrosoftSecurityIncidentCreationAlertRule, ScheduledAlertRule, ThreatIntelligenceAlertRule.""")
    __args__ = dict()
