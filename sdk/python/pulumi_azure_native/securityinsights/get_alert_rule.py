...
warnings.warn("""AlertRule is deprecated. Please use one of the variants: FusionAlertRule, MicrosoftSecurityIncidentCreationAlertRule, ScheduledAlertRule.""", DeprecationWarning)
...
def get_alert_rule(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_alert_rule is deprecated: AlertRule is deprecated. Please use one of the variants: FusionAlertRule, MicrosoftSecurityIncidentCreationAlertRule, ScheduledAlertRule.""")
    __args__ = dict()
