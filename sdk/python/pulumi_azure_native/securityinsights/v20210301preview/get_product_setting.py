...
warnings.warn("""ProductSetting is deprecated. Please use one of the variants: EntityAnalytics, EyesOn, Ueba.""", DeprecationWarning)
...
def get_product_setting(operational_insights_resource_provider: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_product_setting is deprecated: ProductSetting is deprecated. Please use one of the variants: EntityAnalytics, EyesOn, Ueba.""")
    __args__ = dict()
