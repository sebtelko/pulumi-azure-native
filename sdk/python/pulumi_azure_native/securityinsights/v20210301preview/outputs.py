...
class CodelessUiConnectorConfigPropertiesResponse(dict):
    ...
    @property
    @pulumi.getter
    def availability(self) -> Optional['outputs.AvailabilityResponse']:
        """
        Connector Availability Status
        """
    ...
    def connectivity_criteria(self) -> Optional[Sequence['outputs.CodelessUiConnectorConfigPropertiesResponseConnectivityCriteria']]:
        """
    ...
    def data_types(self) -> Optional[Sequence['outputs.CodelessUiConnectorConfigPropertiesResponseDataTypes']]:
        """
    ...
    def description_markdown(self) -> Optional[str]:
        """
    ...
    def graph_queries(self) -> Optional[Sequence['outputs.CodelessUiConnectorConfigPropertiesResponseGraphQueries']]:
        """
    ...
    def instruction_steps(self) -> Optional[Sequence['outputs.CodelessUiConnectorConfigPropertiesResponseInstructionSteps']]:
        """
    ...
    @property
    @pulumi.getter
    def permissions(self) -> Optional['outputs.PermissionsResponse']:
        """
    ...
    def sample_queries(self) -> Optional[Sequence['outputs.CodelessUiConnectorConfigPropertiesResponseSampleQueries']]:
        """
