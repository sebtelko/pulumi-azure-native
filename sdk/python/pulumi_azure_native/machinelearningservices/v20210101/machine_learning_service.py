...
class MachineLearningService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 workspace_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""MachineLearningService is deprecated: MachineLearningService is deprecated. Please use one of the variants: ACIService, AKSService, EndpointVariant.""")
        if opts is None:
