...
warnings.warn("""EventSource is deprecated. Please use one of the variants: EventHubEventSource, IoTHubEventSource.""", DeprecationWarning)
...
def get_event_source(environment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_event_source is deprecated: EventSource is deprecated. Please use one of the variants: EventHubEventSource, IoTHubEventSource.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:timeseriesinsights/v20180815preview:getEventSource', __args__, opts=opts, typ=GetEventSourceResult).value
