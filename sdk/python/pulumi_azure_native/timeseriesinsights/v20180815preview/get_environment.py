...
warnings.warn("""Environment is deprecated. Please use one of the variants: LongTermEnvironment, StandardEnvironment.""", DeprecationWarning)
...
def get_environment(environment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_environment is deprecated: Environment is deprecated. Please use one of the variants: LongTermEnvironment, StandardEnvironment.""")
    __args__ = dict()
