...
warnings.warn("""Environment is deprecated. Please use one of the variants: Gen1Environment, Gen2Environment.""", DeprecationWarning)
...
def get_environment(environment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_environment is deprecated: Environment is deprecated. Please use one of the variants: Gen1Environment, Gen2Environment.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:timeseriesinsights/v20200515:getEnvironment', __args__, opts=opts, typ=GetEnvironmentResult).value
