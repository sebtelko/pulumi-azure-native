...
class DataConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""DataConnection is deprecated: DataConnection is deprecated. Please use one of the variants: EventGridDataConnection, EventHubDataConnection, IotHubDataConnection.""")
        if opts is None:
