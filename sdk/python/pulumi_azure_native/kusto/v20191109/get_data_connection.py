...
warnings.warn("""DataConnection is deprecated. Please use one of the variants: EventGridDataConnection, EventHubDataConnection, IotHubDataConnection.""", DeprecationWarning)
...
def get_data_connection(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_connection is deprecated: DataConnection is deprecated. Please use one of the variants: EventGridDataConnection, EventHubDataConnection, IotHubDataConnection.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20191109:getDataConnection', __args__, opts=opts, typ=GetDataConnectionResult).value
