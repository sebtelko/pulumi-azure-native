...
warnings.warn("""DataConnection is deprecated. Please use one of the variants: EventGridDataConnection, EventHubDataConnection.""", DeprecationWarning)
...
def get_data_connection(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_connection is deprecated: DataConnection is deprecated. Please use one of the variants: EventGridDataConnection, EventHubDataConnection.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/v20190121:getDataConnection', __args__, opts=opts, typ=GetDataConnectionResult).value
