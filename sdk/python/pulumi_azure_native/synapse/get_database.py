...
warnings.warn("""Database is deprecated. Please use one of the variants: ReadWriteDatabase.""", DeprecationWarning)
...
def get_database(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database is deprecated: Database is deprecated. Please use one of the variants: ReadWriteDatabase.""")
    __args__ = dict()
