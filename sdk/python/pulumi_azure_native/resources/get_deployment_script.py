...
warnings.warn("""DeploymentScript is deprecated. Please use one of the variants: AzureCliScript, AzurePowerShellScript.""", DeprecationWarning)
...
def get_deployment_script(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_deployment_script is deprecated: DeploymentScript is deprecated. Please use one of the variants: AzureCliScript, AzurePowerShellScript.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources:getDeploymentScript', __args__, opts=opts, typ=GetDeploymentScriptResult).value
