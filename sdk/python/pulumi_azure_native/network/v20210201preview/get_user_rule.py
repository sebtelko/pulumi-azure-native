...
warnings.warn("""UserRule is deprecated. Please use one of the variants: DefaultUserRule, UserRule.""", DeprecationWarning)
...
def get_user_rule(configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_user_rule is deprecated: UserRule is deprecated. Please use one of the variants: DefaultUserRule, UserRule.""")
    __args__ = dict()
