...
warnings.warn("""AdminRule is deprecated. Please use one of the variants: AdminRule, DefaultAdminRule.""", DeprecationWarning)
...
def get_admin_rule(configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_admin_rule is deprecated: AdminRule is deprecated. Please use one of the variants: AdminRule, DefaultAdminRule.""")
    __args__ = dict()
