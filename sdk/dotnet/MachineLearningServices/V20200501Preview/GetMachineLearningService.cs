...
namespace Pulumi.AzureNative.MachineLearningServices.V20200501Preview
{
    ...
    public static class GetMachineLearningService
    {
        ...
        public static Task<GetMachineLearningServiceResult> InvokeAsync(GetMachineLearningServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMachineLearningServiceResult>("azure-native:machinelearningservices/v20200501preview:getMachineLearningService", args ?? new GetMachineLearningServiceArgs(), options.WithVersion());
    }
