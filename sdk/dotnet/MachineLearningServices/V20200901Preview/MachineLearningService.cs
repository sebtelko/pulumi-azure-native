...
namespace Pulumi.AzureNative.MachineLearningServices.V20200901Preview
{
    ...
    /// </summary>
    [Obsolete(@"MachineLearningService is deprecated. Please use one of the variants: ACIService, AKSService, EndpointVariant.")]
    [AzureNativeResourceType("azure-native:machinelearningservices/v20200901preview:MachineLearningService")]
    public partial class MachineLearningService : Pulumi.CustomResource
    {
        ...
        public MachineLearningService(string name, MachineLearningServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20200901preview:MachineLearningService", name, args ?? new MachineLearningServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineLearningService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20200901preview:MachineLearningService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MachineLearningServiceArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20200901Preview.ComputeEnvironmentType> ComputeType { get; set; } = null!;
