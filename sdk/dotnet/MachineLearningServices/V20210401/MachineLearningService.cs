...
namespace Pulumi.AzureNative.MachineLearningServices.V20210401
{
    ...
    [AzureNativeResourceType("azure-native:machinelearningservices/v20210401:MachineLearningService")]
    public partial class MachineLearningService : Pulumi.CustomResource
    {
        ...
        public MachineLearningService(string name, MachineLearningServiceArgs args, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210401:MachineLearningService", name, args ?? new MachineLearningServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MachineLearningService(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:machinelearningservices/v20210401:MachineLearningService", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class MachineLearningServiceArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.MachineLearningServices.V20210401.ComputeEnvironmentType> ComputeType { get; set; } = null!;
