...
namespace Pulumi.AzureNative.Kusto.V20190907
{
    ...
    public partial class DataConnection : Pulumi.CustomResource
    {
        ...
        public DataConnection(string name, DataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20190907:DataConnection", name, args ?? new DataConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20190907:DataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataConnectionArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.Kusto.V20190907.Kind> Kind { get; set; } = null!;
