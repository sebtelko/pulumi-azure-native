...
namespace Pulumi.AzureNative.Kusto.V20200918
{
    ...
    public static class GetDataConnection
    {
        ...
        public static Task<GetDataConnectionResult> InvokeAsync(GetDataConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataConnectionResult>("azure-native:kusto/v20200918:getDataConnection", args ?? new GetDataConnectionArgs(), options.WithVersion());
    }
