...
namespace Pulumi.AzureNative.Kusto.V20191109
{
    ...
    [AzureNativeResourceType("azure-native:kusto/v20191109:DataConnection")]
    public partial class DataConnection : Pulumi.CustomResource
    {
        ...
        public DataConnection(string name, DataConnectionArgs args, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20191109:DataConnection", name, args ?? new DataConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataConnection(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:kusto/v20191109:DataConnection", name, null, MakeResourceOptions(options, id))
        {
        }
