...
{
    [Obsolete(@"ProductSetting is deprecated. Please use one of the variants: EntityAnalytics, EyesOn, Ueba.")]
    public static class GetProductSetting
    {
        ...
        public static Task<GetProductSettingResult> InvokeAsync(GetProductSettingArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProductSettingResult>("azure-native:securityinsights/v20210301preview:getProductSetting", args ?? new GetProductSettingArgs(), options.WithVersion());
    }
