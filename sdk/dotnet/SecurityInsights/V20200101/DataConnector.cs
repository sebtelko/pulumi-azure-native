...
namespace Pulumi.AzureNative.SecurityInsights.V20200101
{
    ...
    /// Data connector.
    /// </summary>
    [Obsolete(@"DataConnector is deprecated. Please use one of the variants: AADDataConnector, AATPDataConnector, ASCDataConnector, AwsCloudTrailDataConnector, MCASDataConnector, MDATPDataConnector, OfficeDataConnector, TIDataConnector.")]
    ...
    public partial class DataConnector : Pulumi.CustomResource
    {
        ...
        public DataConnector(string name, DataConnectorArgs args, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20200101:DataConnector", name, args ?? new DataConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataConnector(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:securityinsights/v20200101:DataConnector", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataConnectorArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.SecurityInsights.V20200101.DataConnectorKind> Kind { get; set; } = null!;
