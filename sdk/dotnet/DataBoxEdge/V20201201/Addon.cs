...
namespace Pulumi.AzureNative.DataBoxEdge.V20201201
{
    ...
    [AzureNativeResourceType("azure-native:databoxedge/v20201201:Addon")]
    public partial class Addon : Pulumi.CustomResource
    {
        ...
        public Addon(string name, AddonArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20201201:Addon", name, args ?? new AddonArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Addon(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20201201:Addon", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AddonArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20201201.AddonType> Kind { get; set; } = null!;
