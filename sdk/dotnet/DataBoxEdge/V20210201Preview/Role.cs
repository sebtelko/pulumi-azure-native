...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201Preview
{
    ...
    /// Compute role.
    /// </summary>
    [Obsolete(@"Role is deprecated. Please use one of the variants: CloudEdgeManagementRole, IoTRole, KubernetesRole, MECRole.")]
    [AzureNativeResourceType("azure-native:databoxedge/v20210201preview:Role")]
    public partial class Role : Pulumi.CustomResource
    {
        ...
        public Role(string name, RoleArgs args, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201preview:Role", name, args ?? new RoleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Role(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:databoxedge/v20210201preview:Role", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class RoleArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataBoxEdge.V20210201Preview.RoleTypes> Kind { get; set; } = null!;
