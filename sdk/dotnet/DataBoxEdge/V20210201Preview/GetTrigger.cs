...
namespace Pulumi.AzureNative.DataBoxEdge.V20210201Preview
{
    ...
    public static class GetTrigger
    {
        ...
        public static Task<GetTriggerResult> InvokeAsync(GetTriggerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTriggerResult>("azure-native:databoxedge/v20210201preview:getTrigger", args ?? new GetTriggerArgs(), options.WithVersion());
    }
