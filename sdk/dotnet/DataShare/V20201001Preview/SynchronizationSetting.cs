...
namespace Pulumi.AzureNative.DataShare.V20201001Preview
{
    ...
    public partial class SynchronizationSetting : Pulumi.CustomResource
    {
        ...
        public SynchronizationSetting(string name, SynchronizationSettingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:SynchronizationSetting", name, args ?? new SynchronizationSettingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SynchronizationSetting(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20201001preview:SynchronizationSetting", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SynchronizationSettingArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataShare.V20201001Preview.SynchronizationSettingKind> Kind { get; set; } = null!;
