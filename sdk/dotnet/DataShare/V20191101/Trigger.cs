...
namespace Pulumi.AzureNative.DataShare.V20191101
{
    ...
    /// </summary>
    [Obsolete(@"Trigger is deprecated. Please use one of the variants: ScheduledTrigger.")]
    ...
    public partial class Trigger : Pulumi.CustomResource
    {
        ...
        public Trigger(string name, TriggerArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:Trigger", name, args ?? new TriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Trigger(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20191101:Trigger", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class TriggerArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataShare.V20191101.TriggerKind> Kind { get; set; } = null!;
