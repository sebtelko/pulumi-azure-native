...
namespace Pulumi.AzureNative.DataShare.V20200901
{
    ...
    [AzureNativeResourceType("azure-native:datashare/v20200901:DataSetMapping")]
    public partial class DataSetMapping : Pulumi.CustomResource
    {
        ...
        public DataSetMapping(string name, DataSetMappingArgs args, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:DataSetMapping", name, args ?? new DataSetMappingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataSetMapping(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native:datashare/v20200901:DataSetMapping", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DataSetMappingArgs : Pulumi.ResourceArgs
    {
        ...
        public InputUnion<string, Pulumi.AzureNative.DataShare.V20200901.DataSetMappingKind> Kind { get; set; } = null!;
