...
//
// Deprecated: MachineLearningService is deprecated. Please use one of the variants: ACIService, AKSService, EndpointVariant.
...
func NewMachineLearningService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:machinelearningservices/v20200501preview:MachineLearningService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineLearningService(ctx *pulumi.Context,
	...
	var resource MachineLearningService
	err := ctx.ReadResource("azure-native:machinelearningservices/v20200501preview:MachineLearningService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
