...
func NewDataSetMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:datashare/v20201001preview:DataSetMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDataSetMapping(ctx *pulumi.Context,
	...
	var resource DataSetMapping
	err := ctx.ReadResource("azure-native:datashare/v20201001preview:DataSetMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
