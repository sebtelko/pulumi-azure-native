...
func NewEventSource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure-native:timeseriesinsights:EventSource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventSource(ctx *pulumi.Context,
	...
	var resource EventSource
	err := ctx.ReadResource("azure-native:timeseriesinsights:EventSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
